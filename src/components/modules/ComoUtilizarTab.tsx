import { HelpCircle, BookOpen, Users, Calendar, DollarSign, Package, Scissors, FileText } from "lucide-react";
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-3xl">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Guia rápido de cada módulo do FinBeauty</p>
      </div>
